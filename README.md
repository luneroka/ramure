...
Phases 1 to 3 of the plan in [`docs/design-brief.md`](docs/design-brief.md) are done (viewer, editor, accounts and sync); phase 4 is in progress in the order listed there.
