...
const strings = {
  ...
  noLeadsYet: {
    fr: 'Aucune piste pour l’instant. Les pistes de recherche et le lancement des recherches externes arrivent à l’étape suivante.',
    en: 'No leads yet. Research leads and external searches arrive in the next step.',
  },
