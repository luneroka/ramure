...
const strings = {
  ...
  generationsKnown: { fr: 'connues :', en: 'known:' },
  ...
  printRootHint: {
    fr: 'La personne sélectionnée dans l’arbre est à la racine du tableau. Sélectionnez-en une autre pour changer.',
    en: 'The person selected in the tree is the root of the chart. Select another one to change.',
  },
