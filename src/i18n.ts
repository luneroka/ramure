...
const strings = {
  ...
  view: { fr: 'Vue', en: 'View' },
  viewAll: { fr: 'Tout l’arbre', en: 'Whole tree' },
  viewHourglass: { fr: 'Sablier', en: 'Hourglass' },
  showAll: { fr: 'Tout afficher', en: 'Show everyone' },
  ...
  dateNotGuidable: { fr: 'Cette date (calendrier républicain ou texte) ne peut être saisie qu’en texte libre.', en: 'This date (Republican calendar or free text) can only be edited as text.' },
  ...
  photoHint: { fr: 'Stockée sur cet appareil, réduite à 640 px. Un cadrage portrait rend le mieux dans le médaillon.', en: 'Kept on this device, downsized to 640 px. A portrait crop looks best in the medallion.' },
